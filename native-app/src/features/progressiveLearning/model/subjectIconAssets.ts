...
const SUBJECT_ICON_ALIASES: Record<string, SubjectIconKey> = {
  ...
  math: 'mathematics',
  maths: 'mathematics',
  environmental: 'science_technology',
  environmental_activities: 'science_technology',
  creative_activities: 'creative_arts',
  cre: 'religious_education',
  ire: 'religious_education',
  hre: 'religious_education',
  hindu_religious_education_activities: 'religious_education',
  christian_religious_education_activities: 'religious_education',
  islamic_religious_education_activities: 'religious_education',
  indigenous_languages: 'kiswahili',
  indigenous_language_activities: 'kiswahili',
  hygiene_nutrition: 'home_science',
